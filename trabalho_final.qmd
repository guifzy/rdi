...
author: "Lucas de Souza, Guilherme Fernandes, Léo Alec, Samuel Kruguer, Ytalo Nascimento"
format: pdf
...
```{r fig-cargo, echo=FALSE, out.width='80%', fig.cap="Comparativo de salários por nível de experiência.", fig.align='center'}
knitr::include_graphics("C:\\Users\\leozi\\OneDrive\\Área de Trabalho\\trabalho-final-rdi-1\\plots\\CargoAtual.png")
```
...
```{r fig-salarios, echo=FALSE, out.width='80%', fig.cap="Comparativo de salários por nível de experiência.", fig.align='center'}
knitr::include_graphics("C:\\Users\\leozi\\OneDrive\\Área de Trabalho\\trabalho-final-rdi-1\\plots\\FaixaSalarial.png")
```
...
```{r fig-ferramentasETL, echo=FALSE, out.width='80%', fig.cap="Comparativo de salários por nível de experiência.", fig.align='center'}
knitr::include_graphics("C:\\Users\\leozi\\OneDrive\\Área de Trabalho\\trabalho-final-rdi-1\\plots\\FerramentasETL.png")
```
...
```{r fig-genero, echo=FALSE, out.width='80%', fig.cap="Comparativo de salários por nível de experiência.", fig.align='center'}
knitr::include_graphics("C:\\Users\\leozi\\OneDrive\\Área de Trabalho\\trabalho-final-rdi-1\\plots\\output.png")
```

```{r fig-experiencia, echo=FALSE, out.width='80%', fig.cap="Comparativo de salários por nível de experiência.", fig.align='center'}
knitr::include_graphics("C:\\Users\\leozi\\OneDrive\\Área de Trabalho\\trabalho-final-rdi-1\\plots\\SalariosXExp_StateOfDataXGlassdoor.png")
```

```{r fig-tecnologiasDS, echo=FALSE, out.width='80%', fig.cap="Comparativo de salários por nível de experiência.", fig.align='center'}
knitr::include_graphics("C:\\Users\\leozi\\OneDrive\\Área de Trabalho\\trabalho-final-rdi-1\\plots\\TecnologiasDS.png")
```

```{r fig-plataformas, echo=FALSE, out.width='80%', fig.cap="Comparativo de salários por nível de experiência.", fig.align='center'}
knitr::include_graphics("C:\\Users\\leozi\\OneDrive\\Área de Trabalho\\trabalho-final-rdi-1\\plots\\TopPlataformas.png")
```
